...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Type payment amounts in Hindi or Hinglish. Smart parser for seamless UPI payments." },
      { property: "og:title", content: "UPI Translator — Scan. Speak. Pay." },
      { property: "og:description", content: "Pay in the language you think." },
